...
> **Windows full game (`Project1.sln`, enemies, minimap):** checkout **`betaVersionV2-windows`** — see **[BRANCH_SETUP.md](BRANCH_SETUP.md)**.  
> This `main` branch includes shared **`assets/textures/`** and **`game/textures/`** PNGs only.
